...
public class GridAdapterF extends BaseAdapter {
    ...
    public GridAdapterF(Context context, String[] ComSVID, String[] ComID, String[] blob, String[] commName, String[] ComCurrentPrice, String[] ComLastUpdate, String[] ComDistrictID) {
