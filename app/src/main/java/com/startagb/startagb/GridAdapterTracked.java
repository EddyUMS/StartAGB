...
public class GridAdapterTracked extends BaseAdapter {
    ...
    public GridAdapterTracked(Context context, String[] ComSVID, String[] ComID, String[] blob, String[] commName, String[] ComCurrentPrice, String[] ComLastUpdate, String[] ComDistrictID) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView = inflater.inflate(R.layout.grid_item_track,null);

        }

        ImageView updown = convertView.findViewById(R.id.upOrDown);
        ...
        if(comPrices.length>1){


          latestPrice = Double.parseDouble(comPrices[0]);
          prevPrice = Double.parseDouble(comPrices[1]);
            if(latestPrice>prevPrice ){
                updown.setImageResource(R.drawable.arrow_up);

            }else{
                updown.setImageResource(R.drawable.arrow_down);
            }
