...
public class GridAdapterNoti extends BaseAdapter {
   ...
   public String http = MyGlobals.getInstance().getHttp();
    ...
    public GridAdapterNoti(Context context, String[] notiID, String[] recipientID, String[] notiType, String[] userID, String[] comID,  String[] adminEx, String[] createDate, int[]exclusions) {
